...
public class LaskinTest { // Luokan nimen loppu pitää olla Test
    ...
    public void testLisaa() {
        laskin.lisaa(1);
        laskin.lisaa(2);
        assertEquals(3, laskin.annaTulos(), "Lukujen 1 ja 2 summa väärin: Odotettu luku muutettu 3:seksi");
    }
    ...
    public void testJaa() {
        laskin.lisaa(8);
        laskin.jaa(2);
        assertEquals(4, laskin.annaTulos(), "Jakolasku 8/2 väärin: Odotettu muutettu 5:sta -> 4:ksi");
    }
    ...
    public void testKerro() {
        laskin.lisaa(10);
       laskin.kerro(10);
       assertEquals(100, laskin.annaTulos());
    }
}
